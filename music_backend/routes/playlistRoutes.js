...
const {createCtrl,playlistIdCtrl, artistIdCtrl, addSongCtrl, meIdCtrl} = require("../Controllers/playlistCtrl");
...
playlistRoute.get("/get/me", passport.authenticate("jwt", {session: false}),meIdCtrl);
